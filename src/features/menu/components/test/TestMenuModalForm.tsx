...
export const TestMenuModalForm: React.FC<EditMenuFormProps> = ({
  menuItem,
  restaurants,
  isModalOpen,
  setIsModalOpen,
        ...
        <div className="space-y-4">
          {restaurants && (
            <SelectField<TMenuFormValues>
              ...
              options={restaurants?.map((r) => ({ value: r.id, text: r.name }))}
            />
          )}
...
TestMenuModalForm.displayName = "TestMenuModalForm";
